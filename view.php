...
if(!isset($_SESSION['id']))
{
 ...
 $all_contacts = "select * from contacts where user_id = '$_SESSION[id]'";
...
<body>
	<div class="wrapper">
		...
		<div class="content">
			...
			<a class="floatr" href="index.php"><input class="cancel_contact_button" type="button" value="Log Out"></a>
			<a class="floatr" href="insert_contact.php"><input class="cancel_contact_button" type="button" value="New Contact"></a>
			<a class="floatr" href="csvDownload.php"><input class="cancel_contact_button" type="button" value="Download CSV"></a>
			<div class="clear"></div>
			<hr class="pageTitle">
